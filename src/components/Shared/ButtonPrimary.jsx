...
const ButtonPrimary = ({text, icon:Icon}) => {
    return (
        <button className="flex items-center gap-4 bg-[#424242] hover:bg-[#212121] text-white uppercase pl-7 pr-2 py-2 rounded-full group duration-200 text-sm font-normal">
            {text}
